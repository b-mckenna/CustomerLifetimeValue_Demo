## Steve, 
# I took the lifetimes library and made some modifications so it could be used on SE or customer provided datasets on a cluster. I tried to keep it aligned with the [Lifetimes docs](https://lifetimes.readthedocs.io/en/latest/Quickstart.html). 
...
from lifetimes.datasets import load_transaction_data_from_csv
from lifetimes.utils import summary_data_from_transaction_data

transaction_data = load_transaction_data_from_csv()
new_data = transaction_data.toPandas()
print(new_data.head())


summary = summary_data_from_transaction_data(new_data, 'id', 'date', observation_period_end='2018-12-31')
print(summary.head())
...
summary_cal_holdout = calibration_and_holdout_data(transaction_data, 'id', 'date',
                                        calibration_period_end='2018-06-01',
